    ...
    <Fragment>
      ...
      <div className="flex flex-col justify-around ml-20 mr-20 mt-20 md:mt-40 mb-40 text-mini-regular-sz">
        ...
        <p className="mt-4">
          ...
          shall manage your use of our website, passionari accessible at
          passionari.com.
          <br />
          ...
          written here. You must not use this Website if you disagree with any
          of these Website Standard Terms and Conditions. These Terms and
          Conditions have been generated with the help of the Terms And
          Conditions Sample Generator.
          <br />
        ...
        <p className="mt-4">
          Other than the content you own, under these Terms, Passion Ai and/or
          its licensors own all the intellectual property rights and materials
          contained in this Website.
          <br />
          You are granted a limited licence only for purposes of viewing the
        ...
        <p className="mt-2">
          ...
          you and Passion Ai may further restrict access by you to any areas of
        ...
        <p className="mt-4">
          ...
          display on this Website. By displaying Your Content, you grant Passion
          Ai a non-exclusive, worldwide irrevocable, sub licensable licence to
          ...
          third-party’s rights. Passion Ai reserves the right to remove any of
        ...
        <p className="mt-4">
          This Website is provided "as is," with all faults, and Passion Ai
        ...
        <p className="mt-4">
          In no event shall Passion Ai, nor any of its officers, directors and
          ...
          under contract. Passion Ai, including its officers, directors and
        ...
        <p className="mt-4">
          You hereby indemnify to the fullest extent Passion Ai from and against
        ...
        <p className="mt-4">
          Passion Ai is permitted to revise these Terms at any time as it sees
          fit, and by using this Website you are expected to review these Terms
          on a regular basis.
        </p>
        <p className="mt-4 font-bold text-md">Assignment</p>
        <p className="mt-4">
          The Passion Ai is allowed to assign, transfer, and subcontract its
        ...
        <p className="mt-4">
          These Terms constitute the entire agreement between Passion Ai and you
        ...
        <p className="mt-4">
          ...
          <p className="mt-4">
            Questions about the Privacy policy should be sent to us a
            <span className="font-semibold">support@passionaiari.com</span>
          </p>
        </p>
      </div>
    </Fragment>
