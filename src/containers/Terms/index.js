        ...
        <Fragment>
            ...
            <div className="flex flex-col justify-around ml-20 mr-20 mt-40 mb-40 text-mini-regular-sz">
                <p className="mt-4">
                    ...
                    Passion Ai Ari LLP. Passion Ai Ari LLP offers this website, including
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 1 - ONLINE STORE TERMS</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 2 - GENERAL CONDITIONS</span>
                </p>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 5 - PRODUCTS OR SERVICES (If Applicable)</span>
                </p>
                <p className="mt-4">
                    ...
                    any product or service made on this site is void where prohibited. <br/>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</span>
                </p>
                <p className="mt-4">
                    ...
                    judgment, appear to be placed by dealers, resellers or distributors. <br/>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 7 - OPTIONAL TOOLS</span>
                </p>
                <p className="mt-4">
                    ...
                    no liability whatsoever arising from or relating to your use of optional third-party tools. <br/>
                    ...
                    are provided by the relevant third-party provider(s). <br/>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 8 - THIRD-PARTY LINKS</span>
                </p>
                <p className="mt-4">
                    ...
                    any other materials, products, or services of third-parties. <br/>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 10 - PERSONAL INFORMATION</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 12 - PROHIBITED USES</span>
                </p>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</span>
                </p>
                ...
                <p className="mt-4">
                    ...
                    the service at any time, without notice to you. <br/>
                    ...
                    In no case shall Kitchen Desk, our directors, officers, employees, affiliates, agents, contractors,
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 14 - INDEMNIFICATION</span>
                </p>

                <p className="mt-4">
                    You agree to indemnify, defend and hold harmless Perfect Cart and our parent, subsidiaries,
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 15 - SEVERABILITY</span>
                </p>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 16 - TERMINATION</span>
                </p>

                <p className="mt-4">
                    The obligations and liabilities of the parties incurred prior to the termination date shall survive
                    the termination of this agreement for all purposes. <br/>
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 17 - ENTIRE AGREEMENT</span>
                </p>
                <p className="mt-4">
                    ...
                    versions of the Terms of Service). <br/>
                    Any ambiguities in the interpretation of these Terms of Service shall not be construed against the
                    drafting party.
                </p>

                <p className="mt-4">
                    <span className="font-bold">SECTION 18 - CHANGES TO TERMS OF SERVICE</span>
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    <span className="font-bold">SECTION 19 - CONTACT INFORMATION</span>
                </p>

                <p className="mt-4">
                    Questions about the Terms of Service should be sent to us at support@passionaiari.com
                </p>
