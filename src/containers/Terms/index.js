  ...
  return (
    <Fragment>
      ...
      <div className="flex flex-col justify-around ml-20 mr-20 mt-20 md:mt-40 mb-40 text-mini-regular-sz">
        <p className="mt-4">
          This website is operated by Passion Ai Ari LLP. Throughout the site,
          the terms “we”, “us” and “our” refer to Passion Ai Ari LLP. Passion Ai
          Ari LLP offers this website, including all information, tools and
        ...
        <p className="mt-4">
          ...
          In no case shall Kitchen Desk, our directors, officers, employees,
        ...
        <p className="mt-4">
          You agree to indemnify, defend and hold harmless Perfect Cart and our
