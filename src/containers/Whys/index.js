        ...
        <section className="pb-20" id="WhyPassion">
            ...
            <div className="flex lg:justify-around">
                <div className="p-10 md:p-0 md:mt-20 rounded-2xl relative cursor-pointer">
                    ...
                    <div
                        className="text-mini-heading font-bold text-mobile-heading-sz md:text-mini-heading-sz leading-tight">
                    ...
                    <ReactPlayer
                        width={768}
                        height={500}
                        className="hidden md:block mt-20 rounded-2xl overflow-hidden"
                        controls="true"
                        playing
                  ...
                  <ReactPlayer
                      width={324}
                      height={300}
                      className="block md:hidden mt-20 rounded-2xl overflow-hidden"
                      controls="true"
                      playing
                      light={VideoThumbnail}
                      autoplay
